...
- Fix `gls` not restarting after having been updated on macOS (@ngrilly)
- Support `${workspaceFolder}` in `giz.gls.path` (@Jarred-Sumner)
...
## 0.3.0
 ...
 - Add support for optional [Giz Language Server](https://github.com/giztools/gls) integration
...
## 0.1.8 16th July 2018
 - Add auto-formatting using `giz fmt`
 - Syntax updates
